...
class ReMITDataSet(Dataset):
    def __init__(self, args, file_path, neg_size, hist_len, feature_path, directed, transform=None):
    ...
    '''
    def get_pre_emb(self):
        node_emb = dict()
        with open(self.pre_path, 'r') as reader:
            reader.readline()
            for line in reader:
    ...
    def __getitem__(self, idx):
        ...
        neg_nodes = self.negative_sampling()  # 调用下文函数
